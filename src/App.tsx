    ...
    <div className="min-h-screen bg-dinoclass-background text-dinoclass-textMain font-sans flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-dinoclass-background/80 backdrop-blur-md border-b border-dinoclass-surface">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2 text-dinoclass-spark cursor-pointer" onClick={() => setIsAdmin(false)}>
            <Rocket size={28} />
                ...
                <SectionFadeIn>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                      ...
                      <div key={i} className="hover-lift bg-dinoclass-background rounded-2xl overflow-hidden cursor-pointer flex flex-col border border-dinoclass-surface hover:border-dinoclass-spark/50">
